...
var updateTask_exports = {};
__export(updateTask_exports, {
  updateTask: () => updateTask
});
module.exports = __toCommonJS(updateTask_exports);
...
async function updateTask(request, reply) {
  const validateTaskUpdate = import_zod2.z.object({
    userId: import_zod2.z.string().uuid(),
    taskId: import_zod2.z.string().uuid(),
    taskStatus: import_zod2.z.string()
  });
