...
async function appRoutes(app2) {
  app2.post(`${env.CONTEXT_PATH}/user`, register), app2.get(`${env.CONTEXT_PATH}/users`, getAllUsers), app2.get(`${env.CONTEXT_PATH}/tasks/:id`, getUserTasks), app2.post(`${env.CONTEXT_PATH}/login`, createSession), app2.put(`${env.CONTEXT_PATH}/user/update/:id/:isChecked`, updateUser), app2.put(`${env.CONTEXT_PATH}/task/update/:userId/:taskId/:taskStatus`, updateTask), app2.put(`${env.CONTEXT_PATH}/user/update/event`, updateEventDate), app2.get(`${env.CONTEXT_PATH}/user/update/event/:id`, getUserEventDate);
}
